...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE, LPWSTR, int)
{
    ...
    WNDCLASSEXW wc = {
        ...
        nullptr, nullptr, nullptr, nullptr, L"OverlayTestClass", nullptr
    };
    ::RegisterClassExW(&wc);

    HWND hwnd = ::CreateWindowW(
        wc.lpszClassName, L"MumtazWorks Overlay Test", WS_OVERLAPPEDWINDOW,
        100, 100, static_cast<int>(800 * main_scale), static_cast<int>(600 * main_scale),
